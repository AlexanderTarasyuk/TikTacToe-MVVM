package alextarasyuk.game.tictactoe_mvvm;
...
import alextarasyuk.game.tictactoe_mvvm.view.GameActivity;
...
public class GameActivityShould {
    ...
    private Player player1 = new Player("Petya", "x");
    private Player player2 = new Player("Vasya", "o");
